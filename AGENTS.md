...
- Platform is pinned for tooling and its separate desktop update/diagnostics package. Use standard Sparkle, with user-triggered installation and reviewed reports only. Do not add unrelated speech/AI dependencies.
